...
class AdminifyPromo
{
    ...
    public function jltwp_adminify_latest_update_details()
    {
        ...
        $jltwp_adminify_changelog_message = sprintf(
            ...
            // %3$s
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Posts/Page Button, input Search background color issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Welcome Dashboard Close button color issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> All Input Button fields background color and Text color issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> WooCommerce - dark mode issues fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Option Settings > Customization Dark Mode Text Colors issue fixed </span><br>', 'adminify' )
        );
